...
def roulette(type_mise):
    ...
    print("Le chiffre sorti est :",x)#affiche le nombre choisi
    ...
    if x == 0:
        type_mise["mise_vert"]=type_mise["mise_vert"]*36
        print("couleur vert, vous avez gagné :",type_mise["mise_vert"])
    ...
    return(type_mise)
type_mise_new=roulette(type_mise)
print(type_mise_new)